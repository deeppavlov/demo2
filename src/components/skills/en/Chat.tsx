...
<p><strong>NOTE:</strong> <span style="color: #ff0000;"><strong>Please avoid sharing anything sensitive</strong> such as your address, phone number, family member's names, car information, passwords, driver license numbers, insurance policy numbers, loan numbers, credit/debit card numbers, PIN numbers, banking information etc.</span> All of your conversational data may be published on <a href="https://www.deeppavlov.ai">deeppavlov.ai</a> and/or <a href="https://www.github.com/deepmipt">github.com/deepmipt</a> websites for non-commercial purposes of collecting open-domain Conversational AI datasets.</p></div>,
  messageApi: chatApi,
