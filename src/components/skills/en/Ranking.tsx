...
const config: BaseSkillProps<StoreReq, Res> = {
  ...
  desc: (
    <p>
      The ranking component solves the tasks of ranking and paraphrases
      identification based on siamese neural networks with integrated semantic
      similarity measure. The component retrieves the semantically closest
      response from a set of predefined responses. To learn more on
      implementation check out our{" "}
      <CustomLink href="https://deeppavlov.readthedocs.io/en/master/features/models/neural_ranking.html">
        documentation.
      </CustomLink>
      <br />
      This demo was trained on the{" "}
      <CustomLink href="https://github.com/shuzi/insuranceQA">
        InsuranceQA V1
      </CustomLink>{" "}
      dataset.
    </p>
