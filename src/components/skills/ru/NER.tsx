...
const config: BaseSkillProps<StoreReq, Res> = {
  ...
  desc: <div>
    ...
    <br/><br/>
     ...
     Наши модели распознают до 19 сущностей. Больше о моделях и их использовании читайте в <a href="https://docs.deeppavlov.ai/en/master/features/models/NER.html" target="_blank" rel="noopener noreferrer">документации.</a>
