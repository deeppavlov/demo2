...
const config: BaseSkillProps<StoreReq, Res> = {
  ...
  examples: [
    ...
    { 
      question:
        "Музей-квартира Владимир Иванович Немировича-Данченко был создан как филиал Музея МХАТ постановлением Совнаркома СССР от 25 апреля 1943 года в целях увековечения памяти одного из основателей и руководителей Московского Художественного театра. В доме 5 в Глинищевском переулке Немирович-Данченко прожил последние пять лет своей жизни."
    }
  ],
  api: api("http://gpu11.ipavlov.mipt.ru:5000/model"),
